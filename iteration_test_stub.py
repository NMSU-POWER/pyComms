...
c1_2 = current_sensor((464.7253-31.04304j) / ampBase)
c2_1 = current_sensor(-1 * (465.016846-26.31443054j) / ampBase)
c2_3 = current_sensor(232.71 * (math.cos(math.radians(-3.23)) + 1j * math.sin(math.radians(-3.23))) / ampBase)
c2_4 = current_sensor(233.08 * (math.cos(math.radians(-3.25)) + 1j * math.sin(math.radians(-3.25))) /ampBase)

# Create the Node objects with shared info object
Node1 = Node(1, 0, lines=[l1_2], slack=True, current_sensors=[c1_2])
Node2 = Node(.98265, 0, lines=[l1_2, l2_3, l2_4], current_sensors=[c2_1, c2_3, c2_4])
...
print('\n')
print(Node1.live_current_sum())
print(Node2.live_current_sum())